...
document.addEventListener("click", (e)=>{
    ...
    coordX = Math.max(spiderWidth / 2, Math.min(coordX, wall.clientWidth - spiderWidth / 2));
    coordY = Math.max(spiderHeight / 2, Math.min(coordY, wall.clientHeight - spiderHeight / 2));
